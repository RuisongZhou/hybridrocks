...
--stats_interval_seconds=10 --report_file="$output_name/fillseq_report.txt" | tee $output_name/fillseq_runresult.txt
sleep 5s
sync
sudo bash -c "echo 3 > /proc/sys/vm/drop_caches" 
...
--stats_interval_seconds=10 --report_file="$output_name/fillrandom_report.txt" | tee $output_name/fillrandom_runresult.txt
sleep 5s
sync
sudo bash -c "echo 3 > /proc/sys/vm/drop_caches" 
...
--stats_interval_seconds=10 --report_file="$output_name/overwrite_report.txt" | tee $output_name/overwrite_runresult.txt
sleep 5s
sync
sudo bash -c "echo 3 > /proc/sys/vm/drop_caches" 
...
--stats_interval_seconds=10 --report_file="$output_name/readseq_report.txt" | tee $output_name/readseq_runresult.txt
sleep 5s
sync
sudo bash -c "echo 3 > /proc/sys/vm/drop_caches" 
...
--stats_interval_seconds=10 --report_file="$output_name/readrandom_report.txt" | tee $output_name/readrandom_runresult.txt